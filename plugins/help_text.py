    ...
    await update.reply_text(Translation.START_TEXT.format(update.from_user.first_name),
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/AlphaDL'),
                    InlineKeyboardButton('Feedback', url='https://t.me/alphadlsup')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/Alphadl')
                ]
            ]
        ),
